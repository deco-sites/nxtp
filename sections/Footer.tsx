            ...
            <div class="h-full p-[5rem] flex-col">
                ...
                <div class="hidden sm:flex items-center justify-between h-[80%] border-b border-solid border-footer lg:hidden">
                    ...
                    <div class="flex flex-col justify-around items-center">
                        <button class="text-footertablet leading-[1.5] text-heading-1 mb-4 mr-4 border border-solid border-white rounded-[30px] pr-12 pl-8 py-[0.375rem] cursor-pointer transition ease-in-out delay-50 hover:bg-white hover:text-default-inverse">Contact Us</button>
                        <button class="text-footertablet leading-[1.5] text-heading-1 flex items-center border border-solid border-white rounded-[30px] pr-6 pl-8 pr-6 py-1 h-[3.5rem] cursor-pointer transition ease-in-out delay-50 hover:bg-white hover:text-default-inverse">Sign up for newsletter <img class="ml-12 h-[24px]" width={13} height={24} src="/arrow-right.svg" /></button>
                    </div>
                ...
                <div class="flex flex-col items-center justify-between h-[80%] mb-[30px] sm:hidden">
                    ...
                    <div class="flex flex-col justify-around items-center">
                        <button class="text-footertablet leading-[1.5] text-heading-1 mb-4 mr-4 rounded-[30px] pr-12 pl-8 py-[0.375rem] cursor-pointer transition ease-in-out delay-50 hover:bg-white hover:text-default-inverse">Contact Us</button>
                        <button class="text-footertablet leading-[1.5] text-heading-1 flex items-center border border-solid border-white rounded-[30px] pr-6 pl-8 pr-6 py-1 h-[3.5rem] cursor-pointer transition ease-in-out delay-50 hover:bg-white hover:text-default-inverse">Sign up for newsletter <img class="ml-12 h-[24px]" width={13} height={24} src="/arrow-right.svg" /></button>
                    </div>
